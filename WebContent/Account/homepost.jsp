...
<form method="post" encType="multipart/form-data" action="../post2dlt" class="form table"> 
...
<a class="be-post-title">
	                                    <label for="RoomName">Room Title</label>
	                                    <input type="text" name="RoomName" id="RoomName" placeholder="Room Title">
</a>
<a class="be-post-title">
...
%>
 	                                     ...
 	                                     <option value="<%=rs.getString(2)%>" style="color:red;font-family:cursive;weight:bold;"><%=rs.getString(2)%></option>
<%   }     %>
</select>
</a>
<%
...
<a class="be-post-tag"><input type="rate" name="rating" class="w3-input" placeholder="AC/Non AC"></a>,  
</span>
<div class="author-post">
<img src="upload/<%=session.getAttribute("image")%>" class="img-circle">
